        ...
        {!registered ? (
          <div className="space-y-8 relative z-10">
            <div className="text-center space-y-3">
              <span className="text-[10px] font-black text-violet-400 bg-violet-950/50 border border-violet-850 px-4 py-1.5 rounded-full inline-block uppercase tracking-widest">
            ...
            <form onSubmit={handleRegister} className="space-y-5 max-w-xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full h-12 px-4 rounded-xl bg-slate-950 border border-slate-800 text-white placeholder-slate-600 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all font-semibold text-sm"
                  />
                </div>
              ...
              <div className="flex items-center gap-3 bg-slate-950/30 border border-slate-850 p-4 rounded-xl text-xs font-semibold text-slate-400">
                <span className="text-cyan-400 shrink-0 text-base">🛡️</span>
                <span>Sus datos corporativos serán tratados con estricta confidencialidad por el comité organizador de la Red Universitaria de Innovación (RUI).</span>
              </div>

              {/* Submit Button */}
              <button 
                type="submit" 
                className="w-full h-14 mt-4 inline-flex items-center justify-center font-black text-sm uppercase tracking-widest rounded-2xl bg-gradient-to-r from-blue-600 via-violet-600 to-cyan-500 text-white hover:opacity-95 active:scale-[0.98] transition-all shadow-xl shadow-violet-950/20"
              >
          ...
          <div className="relative z-10 animate-[fadeIn_0.5s_ease-out] max-w-xl mx-auto space-y-8 text-center">
            ...
            <div className="space-y-2">
              <div className="w-16 h-16 bg-emerald-500/10 border border-emerald-500/30 rounded-full flex items-center justify-center text-emerald-400 mx-auto mb-3 shadow-lg shadow-emerald-950/20 text-2xl">
                ✓
              </div>
            ...
            <div className="relative w-full bg-slate-950 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
              ...
              {/* Ticket Top bar */}
              <div className="bg-gradient-to-r from-blue-900 via-violet-850 to-cyan-800 px-6 py-4 flex items-center justify-between text-left text-white">
                <div className="flex flex-col">
                  <span className="text-[9px] font-black tracking-widest uppercase text-cyan-300">Pase Digital de Evaluación</span>
                  <span className="text-xs font-black uppercase tracking-wider">III Simposio Internacional</span>
                </div>
                <span className="text-xs font-black bg-white/10 px-3 py-1 rounded border border-white/15 uppercase tracking-wide">Aforo: 100</span>
              </div>
              ...
              <div className="p-6 space-y-6 text-left relative">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                  ...
                  <div>
                    ...
                    <span className="text-xs sm:text-sm font-black text-cyan-400 font-mono">{ticketCode}</span>
                  </div>
                  <div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 justify-between">
                  <div className="space-y-1.5 text-center sm:text-left">
                    ...
                    <div className="text-[10px] text-cyan-400 font-bold uppercase tracking-wide">4:00 PM – Auditorio CCIA Arequipa</div>
                  </div>
            ...
            <p className="text-slate-400 text-xs leading-relaxed font-semibold max-w-sm mx-auto">
              Se ha enviado un correo con los detalles de tu postulación y el número de contacto del MC a <span className="text-cyan-400 font-bold">{formData.email}</span>.
            </p>

            <button 
              onClick={() => setRegistered(false)} 
              className="inline-flex items-center justify-center text-xs font-black uppercase tracking-wider text-slate-500 hover:text-slate-350 transition-colors"
            >
